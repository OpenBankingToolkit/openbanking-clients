...
public interface TokenUsageService {
    ...
    void incrementTokenUsage(TokenUsage... tokenUsage);

    void incrementTokenUsage(AccessTokenResponse accessTokenResponse);

    void increment(Collection<TokenUsage> tokenUsages);
}
