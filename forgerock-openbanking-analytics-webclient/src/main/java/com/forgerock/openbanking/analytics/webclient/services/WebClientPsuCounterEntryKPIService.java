...
@Slf4j
@Service
public class WebClientPsuCounterEntryKPIService implements PsuCounterEntryKPIService {

    private final WebClient webClient;
    private final MetricsConfiguration metricsConfiguration;
    private final Tracer tracer;

    public WebClientPsuCounterEntryKPIService(WebClient webClient, MetricsConfiguration metricsConfiguration, Tracer tracer) {
